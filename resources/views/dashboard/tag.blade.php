                                ...
                                <div class="modal-content rounded-0 overview-dropdown-dark-theme">
                                    <div class="modal-body">
                                        ...
                                        <form action="/dashboard/tag/add/task" method="POST">
                                            <input type="hidden" name="id" value="{{ $tagId }}">
                                            <input type="text"
                                                class="input-outline-off form-control px-0 bg-transparent mb-2 border-0 border-bottom"
                                                placeholder="Title" aria-label="Title" name="title">
                                            <select
                                                class="input-outline-off border-0 px-0 bg-transparent border-bottom form-select mb-2"
                ...
                <ul class="overview-items m-0 p-0 mt-4">
                    @foreach ($tasks->items() as $task)
                        <li class="border rounded py-2 px-3 mb-2 cursor-pointer"
                            onclick="window.location.href='/dashboard/tag/{{ $tagId }}/{{ $tagTitle }}/?clr={{ $color }}&view={{ $task->id }}{{ $queryParams }}'">
                            <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="modal-content rounded-0 preview-date-dark-theme">
                                        <div class="modal-body">
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                ...
                                                <i data-feather="x" class="aspect-ratio icon-w-17" data-bs-target="modal"
                                                    data-bs-dimiss="Close" style="cursor: pointer;"></i>
                                            </div>
                                            <div class="row g-2">
                                                <div class="col">
